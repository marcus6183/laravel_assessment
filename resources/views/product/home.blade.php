    ...
    <div class="p-2 flex flex-col gap-4">
        ...
        <div class="overflow-auto">
            <table class="w-full bg-white border">
                <thead>
                    <tr>
                        <th class="w-10 px-6 py-3 border text-left font-bold">No.</th>
                        <th class="px-6 py-3 border text-left font-bold">Name</th>
                        <th class="w-10 px-6 py-3 border text-left font-bold">Price (RM)</th>
                        <th class="px-6 py-3 border text-left font-bold">Details</th>
                        <th class="w-5 px-6 py-3 border text-left font-bold">Publish</th>
                        <th class="w-20 px-6 py-3 border text-left font-bold">Action</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td class="px-6 py-4 border whitespace-nowrap">{{ Str::limit($product->details, 100) }}</td>
